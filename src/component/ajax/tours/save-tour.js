...
function SaveTourList() {
    ...
    // const handleSearch = () => {
    //     // Lọc danh sách tour theo điểm đến và ngân sách
    //     const filtered = tours.filter((tour) => {
    //       const matchesDestination = tour.departurelocation
    //         .toLowerCase()
    //         .includes(destination.toLowerCase());
          
    //       const matchesPrice = selectedPrice
    //         ? (selectedPrice === 'Dưới 5 triệu' && tour.price < 5000000) ||
    //           (selectedPrice === 'Từ 5 đến 10 triệu' && tour.price >= 5000000 && tour.price <= 10000000) ||
    //           (selectedPrice === 'Từ 10 đến 20 triệu' && tour.price > 10000000 && tour.price <= 20000000) ||
    //           (selectedPrice === 'Trên 20 triệu' && tour.price > 20000000)
    //         : true;
    
    //       return matchesDestination && matchesPrice;
    //     });
    //     setFilteredTours(filtered); // Cập nhật danh sách sau khi lọc
    // };
