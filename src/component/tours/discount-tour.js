...
import DiscountTourList from "../ajax/tours/discount-tour";

function DiscountTour(){
    return(
        <div>
            <Header />
                ...
                <div className="">
                    ...
                    <div className="w-[50%] flex mx-auto gap-10 justify-center items-center">
                        ...
                        <Link to={"/discount-tour"}>
                            ...
                            <div className="font-semibold my-3 text-[#007aff]">Tour khuyến mãi</div>
                        </Link>
                    </div>
